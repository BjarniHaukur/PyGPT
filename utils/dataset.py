...
if __name__ == "__main__":
    ...
    memmap_train = np.memmap(DATA_PATH / "train2.dat", mode="w+", dtype='uint16', shape=(len(tokens_train),))
    ...
    memmap_eval = np.memmap(DATA_PATH / "eval2.dat", mode="w+", dtype='uint16', shape=(len(tokens_eval),))
